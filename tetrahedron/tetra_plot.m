...
title('$\psi_{m,n}$','Interpreter','Latex');
view(0,90);
daspect([1 1 0.2])
ylim([0,sqrt(3)])

nexttile
zfun = @(x1,x2) cos(pi*((-m-n)+m)*x1+pi*((-m-n)-m)*x2/sqrt(3));
trisurf(F,x,y,zfun(x,y),'Linestyle','none')
xlabel('$x_1$','Interpreter','Latex');
ylabel('$x_2$','Interpreter','Latex');
title('$\psi_{-m-n,m}$','Interpreter','Latex');
view(0,90);
daspect([1 1 0.2])
ylim([0,sqrt(3)])

nexttile
zfun = @(x1,x2) cos(pi*(n+(-m-n))*x1+pi*(n-(-m-n))*x2/sqrt(3));
trisurf(F,x,y,zfun(x,y),'Linestyle','none')
xlabel('$x_1$','Interpreter','Latex');
ylabel('$x_2$','Interpreter','Latex');
title('$\psi_{n,-m-n}$','Interpreter','Latex');
view(0,90);
daspect([1 1 0.2])
ylim([0,sqrt(3)])
...
xlabel('$x_1$','Interpreter','Latex');
ylabel('$x_2$','Interpreter','Latex');
title('$\psi_{n,m}$','Interpreter','Latex');
view(0,90);
daspect([1 1 0.2])
ylim([0,sqrt(3)])
